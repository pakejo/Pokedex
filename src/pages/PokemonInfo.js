        ...
        return (
            <div className="bg-pokemon m-0 p-0">
                <div className="container mt-3">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="d-flex flex-row justify-content-start">
                                {this.state.types.map((type, index) => (
                                    <div
                                        key={index}
                                        className="p-2 mr-3 badge badge-primary"
                                        style={{background: TYPE_COLORS_GRADIENTS[type]}}
                                    >
                            ...
                            <div className="comtainer-fluid">
                                {this.state.weakness.map((type, index) => (
                                    <div
                                        key={index}
                                        className="p-2 mr-3 mb-3 badge badge-primary"
                                        style={{background: TYPE_COLORS_GRADIENTS[type]}}
                                    >
                                        <h5 className="mb-0">{type}</h5>
                                    </div>
                            ...
                            <h3 className="mt-3 d-flex justyify-content-space-between">
                                Special ability:
                                <div
                                    className="badge badge-secondary d-inline-flex align-items-center justify-content-start">
                                    <div className="">{this.state.ability.name}</div>
                                </div>
                            </h3>
                    ...
                    <Link
                        className="my-2 btn btn-success btn-block"
